    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semibold text-4xl leading-tight mt-1">Desperados</h2>
                ...
                <p class="mt-12">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptatum iste labore aut possimus cumque at quas similique qui est eveniet. Ipsa esse aut omnis adipisci! Fugiat unde aperiam est consequatur.</p>
                <div class="mt-12">
        ...
        <div class="similar-games-container mt-8">
            <div class="text-blue-500 uppercase tracking-wide font-semibold">Similar games</div>
            <div class="popular-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="/1.png" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="absolute bottom-0 right-0 w-16 h-16 bg-gray-800 rounded-full" style="right:-20px; bottom: -20px;">
                            <div class="font-semibold text-xs flex justify-center items-center h-full">80%</div>
                        </div>
                    </div>
                    <a href="#" class="block text-base font-semibold leading-tight hover:text-gray-400 mt-8">Final Fantasy 8 remake</a>
